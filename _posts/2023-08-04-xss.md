...
To accomplish this, I embedded the following code in my profile page:
...
- `www.example32a.com` : CSP policies set by the web server

- `www.example32a.com` : CSP policies set by the web application
