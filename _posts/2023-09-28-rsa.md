...
The message to sign is: "I owe you $2000."

The message can be converted to a hex string using the below Python code:
...
An alternate message that is a slight variation of the original message will also be signed: "I owe you $3000."

The alternate message can be converted to a hex string using the below Python code:
